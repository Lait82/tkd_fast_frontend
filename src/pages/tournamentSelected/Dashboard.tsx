...
const Dashboard = () => {
    ...
    const {tournament, can} = useTournament()
    ...
    const actions = [
        ...
        description: "Aca vas a poder ver las llaves cuando esten disponibles y el cronograma de tus torneos.",
        allowed: true,
        action: () => navigate("/"),
        },
        {
        ...
        description: "UMira información detallada del torneo en el perfil del evento.",
        allowed: true,
        action: () => navigate("/"),
        },
        {
        ...
        description: "Contáctanos por Whatsapp y obtén tu código de torneo.",
        allowed: true,
        ...
        description: "Agregá categorias, editá los pesos y cinturones de cada categoría.",
        allowed: true,
        action: () => navigate("/"),
        },
        {
        ...
        description: "Invita formalmente a maestros de otras escuelas/asociaciones para que puedan invitar a sus instructores.",
        allowed: true,
        action: () => navigate("/"),
        },
        {
                ...
                {actions.map((action, index) => (
                    <div key={index} className="action-item" onClick={action.action}>
                        ...
                        <div className="action-content">
                            ...
                            <p>
                                {action.description} <span className="action-highlight font-black">{`>>>`}</span>
                            </p>
                        </div>
                    </div>
                ))}
