...
const TeamDropdown = ({ team }: TeamDropdownProps) => {
    const { competitorDraft, userCompetitors, updateCompetitors, updateTeams } =
    ...
    const handleButtonClick = async () => {
        try {
            const res = await kickCompetitor(team.uuid, competitorDraft.uuid);
            const kickCompetitorRes = kickCompetitorResponseSchema.parse(res);

            updateCompetitors(kickCompetitorRes.competitor);
            updateTeams(kickCompetitorRes.team);
