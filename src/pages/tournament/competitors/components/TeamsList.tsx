    ...
    return (
        <>
            {teams.map((team) => {
                return (
                    <div
                        className="flex justify-between transition-all ease-fluid rounded-lg px-1.5 py-1 cursor-pointer capitalize border border-transparent hover:border-orange"
                        key={team.uuid}
                        onClick={() => {
                            setTeamDraft(team);
