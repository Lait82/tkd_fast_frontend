...
const rankColors: Record<Rank, { belt: string; tip: string }> = {
    WHITE: { belt: "var(--color-neutrallight)", tip: "var(--color-neutrallight)" },
    WHITE_YELLOW: { belt: "var(--color-neutrallight)", tip: "var(--color-yellow)" },
...
<svg 
width={size} 
height={size * 0.33} viewBox={`0 0 212 106`} className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.703125 20.0469V39.3828H57.5391L69.8438 20.6328L81.5625 0.710938L41.1328 0.125H0.703125V20.0469ZM90.3516 0.710938C89.1797 0.710938 35.8594 85.0859 35.2734 86.2578C35.2734 87.4297 62.2266 104.422 62.8125 104.422L129.023 0.710938H90.3516ZM136.641 1.29688L133.711 5.39844L131.953 8.32812L133.125 11.2578L139.57 26.4922L144.844 39.3828H211.055V0.125H174.141C139.57 0.125 137.227 0.125 136.641 1.29688Z" fill={belt}/>
<path d="M117.305 32.5367L107.344 49.5289L118.477 77.6539L130.195 105.779C131.953 105.779 160.078 93.4742 160.078 92.8883L128.438 16.7164C127.852 15.5445 126.68 17.3023 117.305 32.5367Z" fill={tip}/>
</svg>
)};
